...
## app.html with myw own tag - kurtid
````html
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="box">
    <div class="form">
        ...
        <div class="inputBox">
            <input data-kurtid="username" type="text" required="required">
            <span>Username</span>
            <i></i>
        </div>

        <div class="inputBox">
            <input data-kurtid="password" type="password" required="required">
            <span>Password</span>
            <i></i>
        </div>

        <input data-kurtid="login" type="submit" value="Login">
    </div>
</div>
...
export default defineConfig({
  ...
  use: {
    ...
    /* Collect trace when retrying the failed test. See https://playwright.dev/docs/trace-viewer */
    trace: 'on-first-retry',
    // selector 6 test-dataid
    testIdAttribute: 'data-kurtid',
  },
